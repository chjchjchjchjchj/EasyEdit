...
models_implement = ['mistral','llama2chat','gpt2','gptj']
models_implement = ['gpt2']
# model_names = ['./hugging_cache/Mistral-7B-v0.1','./hugging_cache/llama2-7b-chat','./hugging_cache/gpt2-xl','./hugging_cache/gpt-j-6B']
model_names = ['/home/chengdong/haojun/hgmodel/gpt2-xl']
...
if __name__ == "__main__":
    ...
    parser.add_argument('--metrics_save_dir', default='./concept_edit_final_result_upload', type=str) # HJ
    parser.add_argument('--inter', action='store_true')

    args = parser.parse_args()

    args.metrics_save_dir = args.metrics_save_dir + "_" + args.edited_model + "_" + args.editing_method
